...
primary ansible_host=10.0.1.10 ansible_user=ubuntu ansible_port=22 ansible_ssh_private_key_file=/path/to/key.pem
secondary ansible_host=10.0.1.11 ansible_user=ubuntu ansible_port=22 ansible_ssh_private_key_file=/path/to/key.pem  
secondary2 ansible_host=10.0.1.12 ansible_user=ubuntu ansible_port=22 ansible_ssh_private_key_file=/path/to/key.pem
...
ok: [primary] => {
    "msg": [
        ...
        "",  
        "Cluster Members:",
        "├─ primary (10.0.1.10) - Primary",
        "├─ secondary (10.0.1.11) - Secondary", 
        "└─ secondary2 (10.0.1.12) - Secondary2",
        "",
        "🔗 Connection Commands:",
        "├─ Direct Connection: mongo 10.0.1.10:27017",
        "├─ Replica Set Connection: mongo \"mongodb://primary:27017/admin?replicaSet=rs0\"",
        "└─ Authenticated Connection: mongo \"mongodb://admin:PASSWORD@10.0.1.10:27017/admin\"",
        "",
        "📝 Next Steps:",
